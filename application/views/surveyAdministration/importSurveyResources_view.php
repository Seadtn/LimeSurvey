        ...
        <div class="row welcome survey-action">
            <div class="col-12 content-right">
                <div class="jumbotron message-box">
                    ...
                    <p>
                        <input class="btn btn-outline-secondary btn-lg" type='submit' value='<?php eT("Backee"); ?>' onclick="window.open('<?php echo $this->createUrl('surveyAdministration/rendersidemenulink/', ['surveyid' => $surveyid, 'subaction' => 'resources']); ?>', '_top')"/>
                    </p>
                </div>
            </div>
        </div>
